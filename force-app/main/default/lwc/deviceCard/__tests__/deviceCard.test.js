...
describe("c-device-card", () => {
  ...
  it("Device Card for Phone with Unlimited Data", async () => {
    ...
    expect(ps[1].textContent).toContain(
      testData.Phone.Usage__r.Unit_of_Measure__c
    );
  ...
  it("Device Card for Tablet with Limited SMS", async () => {
    ...
    expect(ps[1].textContent).toContain(
      testData.Tablet.Usage__r.Unit_of_Measure__c
    );
    expect(ps[1].textContent).toContain(
      "" + testData.Tablet.Usage__r.Allotted_Usage__c
    );
  ...
  it("Device Card for Watch with Limited Minutes", async () => {
    ...
    expect(ps[1].textContent).toContain(
      testData.Watch.Usage__r.Unit_of_Measure__c
    );
    expect(ps[1].textContent).toContain(
      "" + testData.Watch.Usage__r.Allotted_Usage__c
    );
